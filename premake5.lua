...
group "Dependencies"
    -- include [prj.path]
    includeexternal "~vendor/glad-OpenGL_4.4" -- includeexternal for upcoming workspace/solutions so that it dosen't needs to recompile
    includeexternal "~vendor/glfw"            -- includeexternal for upcoming workspace/solutions
    includeexternal "~vendor/imgui"           -- includeexternal for upcoming workspace/solutions
group ""

includeexternal "OpenGL-Laboratory" -- includeexternal for upcoming workspace/solutions
include "Autocorrect"